...
template <> constexpr inline auto MapWidget::qt_create_metaobjectdata<qt_meta_tag_ZN9MapWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'proximityAlert'
        QtMocHelpers::SignalData<void(const QString &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'updateRadarSweep'
...
void MapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->proximityAlert((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->updateRadarSweep(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MapWidget::*)(const QString & )>(_a, &MapWidget::proximityAlert, 0))
            return;
    }
}
...
// SIGNAL 0
void MapWidget::proximityAlert(const QString & _t1)
{
